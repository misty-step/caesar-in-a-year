...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyle = "inline-flex items-center justify-center px-6 py-3 border text-sm font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200";
  ...
  return (
    ...
    >
      ...
      {/* 
        Enforce standardized behavior: 
        If labels are provided, use the breathing cycle. 
        Otherwise, fallback to children.
      */}
