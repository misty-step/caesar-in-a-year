...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-ink text-parchment border-t border-slate-700 font-sans">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-tyrian-600 rounded-page flex items-center justify-center text-white font-serif font-bold text-xl">
                C
              </div>
          ...
          <div className="lg:col-span-2">
            <h3 className="text-sm font-semibold tracking-wider uppercase text-slate-200 mb-4">
              Explorare
            </h3>
          ...
          <div className="lg:col-span-4">
            ...
            <form className="flex flex-col sm:flex-row gap-2" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="appearance-none min-w-0 w-full bg-slate-800 border border-slate-600 rounded-card py-2 px-4 text-base text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-tyrian-500 focus:border-tyrian-500 sm:text-sm transition-colors"
              />
              <button
                type="submit"
                className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-card shadow-sm text-white bg-tyrian-600 hover:bg-tyrian-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-ink focus:ring-tyrian-500 transition-colors"
              >
                Scribere
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center mt-4 md:mt-0 text-xs text-slate-500">
...
const SocialLink: React.FC<{ href: string; label: string; children: React.ReactNode }> = ({ href, label, children }) => (
  <a
    href={href}
    className="text-slate-400 hover:text-tyrian-500 transition-colors duration-200"
    aria-label={label}
  >
